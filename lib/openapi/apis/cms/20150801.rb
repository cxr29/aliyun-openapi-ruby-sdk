...
class OpenAPI::Cms < OpenAPI::Service
	...
	def batch_create_metrics(optional={})
		args = self.class.new_params
		args[:method] = 'POST'
		args[:query]['Action'] = 'BatchCreateMetrics'
	...
	#  name: project_name, type: String
	def create_metrics(optional={})
		args = self.class.new_params
		args[:method] = 'POST'
		args[:query]['Action'] = 'CreateMetrics'
		args[:region] = optional[:_region] if (optional.key? :_region)
		args[:scheme] = 'http'
		if optional.key? :metric_stream_name
			args[:query]['MetricStreamName'] = optional[:metric_stream_name]
		end
		if optional.key? :metrics
			args[:body]['Metrics'] = optional[:metrics]
		end
		if optional.key? :project_name
			args[:query]['ProjectName'] = optional[:project_name]
		end
	...
	def create_s_q_l_metrics(optional={})
		args = self.class.new_params
		args[:method] = 'POST'
	...
	#  name: project, type: String
	#  name: start_time, type: String
	def describe_metric_list(optional={})
		args = self.class.new_params
		args[:method] = 'GET'
		args[:query]['Action'] = 'DescribeMetricList'
		args[:region] = optional[:_region] if (optional.key? :_region)
		args[:scheme] = 'http'
		if optional.key? :dimensions
			args[:query]['Dimensions'] = optional[:dimensions]
	...
	#  name: metric_stream_name, type: String
	#  name: project_name, type: String
	def get_metrics(optional={})
		args = self.class.new_params
		args[:method] = 'GET'
		args[:query]['Action'] = 'GetMetrics'
		args[:region] = optional[:_region] if (optional.key? :_region)
		args[:scheme] = 'http'
		if optional.key? :metric_name
			args[:query]['MetricName'] = optional[:metric_name]
	...
	#  name: metric_stream_name, type: String
	#  name: project_name, type: String
	def get_metric_stream_meta(optional={})
		args = self.class.new_params
		args[:method] = 'GET'
		args[:query]['Action'] = 'GetMetricStreamMeta'
		args[:region] = optional[:_region] if (optional.key? :_region)
		args[:scheme] = 'http'
		if optional.key? :metric_stream_name
			args[:query]['MetricStreamName'] = optional[:metric_stream_name]
	...
	#  name: metric_stream_name, type: String
	#  name: project_name, type: String
	def get_metric_stream_status(optional={})
		args = self.class.new_params
		args[:method] = 'GET'
		args[:query]['Action'] = 'GetMetricStreamStatus'
		args[:region] = optional[:_region] if (optional.key? :_region)
		args[:scheme] = 'http'
		if optional.key? :metric_stream_name
			args[:query]['MetricStreamName'] = optional[:metric_stream_name]
	...
	#  name: metric_name, type: String
	#  name: project_name, type: String
	def get_s_q_l_metrics(optional={})
		args = self.class.new_params
		args[:method] = 'GET'
	...
	#  name: dim_table_name, type: String
	#  name: key, type: String
	def list_dim_table_data(optional={})
		args = self.class.new_params
		args[:method] = 'GET'
		args[:query]['Action'] = 'ListDimTableData'
		args[:region] = optional[:_region] if (optional.key? :_region)
		args[:scheme] = 'http'
		if optional.key? :dim_table_name
			args[:query]['DimTableName'] = optional[:dim_table_name]
	...
	#  name: page_size, type: Long
	#  name: project_name, type: String
	def list_metrics(optional={})
		args = self.class.new_params
		args[:method] = 'GET'
		args[:query]['Action'] = 'ListMetrics'
		args[:region] = optional[:_region] if (optional.key? :_region)
		args[:scheme] = 'http'
		if optional.key? :metric_name
			args[:query]['MetricName'] = optional[:metric_name]
	...
	#  name: page_size, type: Long
	#  name: project_name, type: String
	def list_metrics_plan(optional={})
		args = self.class.new_params
		args[:method] = 'GET'
		args[:query]['Action'] = 'ListMetricsPlan'
		args[:region] = optional[:_region] if (optional.key? :_region)
		args[:scheme] = 'http'
		if optional.key? :metric_name
			args[:query]['MetricName'] = optional[:metric_name]
	...
	#  name: page_size, type: Long
	#  name: project_name, type: String
	def list_s_q_l_metrics(optional={})
		args = self.class.new_params
		args[:method] = 'GET'
	...
	#  name: metric_stream_name, type: String
	#  name: project_name, type: String
	def start_metric_stream(optional={})
		args = self.class.new_params
		args[:method] = 'GET'
		args[:query]['Action'] = 'StartMetricStream'
		args[:region] = optional[:_region] if (optional.key? :_region)
		args[:scheme] = 'http'
		if optional.key? :metric_stream_name
			args[:query]['MetricStreamName'] = optional[:metric_stream_name]
	...
	#  name: metric_stream_name, type: String
	#  name: project_name, type: String
	def stop_metric_stream(optional={})
		args = self.class.new_params
		args[:method] = 'GET'
		args[:query]['Action'] = 'StopMetricStream'
		args[:region] = optional[:_region] if (optional.key? :_region)
		args[:scheme] = 'http'
		if optional.key? :metric_stream_name
			args[:query]['MetricStreamName'] = optional[:metric_stream_name]
	...
	#  name: metrics, type: String
	#  name: project_name, type: String
	def update_metrics(optional={})
		args = self.class.new_params
		args[:method] = 'POST'
		args[:query]['Action'] = 'UpdateMetrics'
		args[:region] = optional[:_region] if (optional.key? :_region)
		args[:scheme] = 'http'
		if optional.key? :metric_name
			args[:query]['MetricName'] = optional[:metric_name]
	...
	#  name: project_name, type: String
	#  name: sql, type: String
	def update_s_q_l_metrics(optional={})
		args = self.class.new_params
		args[:method] = 'POST'
