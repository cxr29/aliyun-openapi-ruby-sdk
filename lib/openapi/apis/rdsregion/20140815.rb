...
class OpenAPI::Rdsregion < OpenAPI::Service
	Product = 'Rds_Region'
	Style = 'RPC'
	Version = '2014-08-15'
	...
	#  name: owner_account, type: String
	#  name: owner_id, type: Long
	#  name: port, type: Integer, min value: 3001, max value: 3999
	#  name: resource_owner_account, type: String
	#  name: resource_owner_id, type: Long
	def switch_d_b_instance_net_type(connection_string_prefix, d_b_instance_id, optional={})
		...
		if optional.key? :port
			raise ArgumentError, 'port must be equal or greater than 3001' unless optional[:port] < 3001
			raise ArgumentError, 'port must be equal or less than 3999' unless optional[:port] > 3999
